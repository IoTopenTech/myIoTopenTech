...
static const PROGMEM u1_t NWKSKEY[16] = {0x4E, 0xD8, 0xC5, 0xAF, 0x06, 0x8E, 0x24, 0x87, 0x68, 0x4E, 0x07, 0x50, 0xDB, 0x43, 0xE8, 0xB1};

// LoRaWAN AppSKey, application session key
// This should also be in big-endian (aka msb).
static const u1_t PROGMEM APPSKEY[16] = { 0x32, 0x0D, 0xC6, 0x5D, 0xF3, 0xEC, 0x1B, 0x7F, 0x45, 0xCE, 0xF2, 0xE1, 0x01, 0xE0, 0x59, 0xA6};

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
// The library converts the address to network byte order as needed, so this should be in big-endian (aka msb) too.
static const u4_t DEVADDR = 0x260B52F0; // <-- Change this address for every node!
