...
uint32_t periodo_heartbeat = 1;                  //minutos
...
#define ABP_DEVADDR  {0x26, 0x0B, 0xE5, 0xFB}
#define ABP_APPSKEY  {0x1E, 0xC9, 0xF3, 0x88, 0x6E, 0xC9, 0xBD, 0xD4, 0x1F, 0xB6, 0x13, 0xAA, 0xC9, 0xC9, 0xC9, 0xC9}
#define ABP_NWKSKEY  {0x66, 0xC9, 0x53, 0x4A, 0x6E, 0x39, 0xC9, 0xCB, 0x3B, 0xBD, 0xAC, 0x5E, 0xC9, 0xC9, 0xC9, 0xC9}
...
api.lorawan.dr.set(2);//LoRa: SF10 / 125 kHz
...
void loop() {
  ...
  if (((elapsed = millis() - last) > (periodo_heartbeat * 60000)) || interrupcion_puerta_abierta || interrupcion_puerta_cerrada) {
    uplink_routine();
    last = millis();
  }
  //Serial.printf("Try sleep %ums..", (periodo_heartbeat * 60000));
  api.system.sleep.all(periodo_heartbeat * 60000);
