...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTB, 13, PIO_DIGITAL    , PIN_ATTR_NONE                   , No_ADC_Channel, TC4_CH1   , TCC3_CH1    , EXTERNAL_INT_13   }, // MIC_INT
  { PORTB, 12, PIO_DIGITAL    , PIN_ATTR_NONE                   , No_ADC_Channel, TC4_CH0   , TCC3_CH0    , EXTERNAL_INT_12   }, // GPS_TIMER

  
  { PORTB, 22, PIO_SERCOM   , PIN_ATTR_PWM_E                  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6    }, // TX1
  { PORTA,  4, PIO_DIGITAL, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channel4  , TC0_CH0   , TC0_CH0     , EXTERNAL_INT_4    }, // D3 
  { PORTA,  5, PIO_DIGITAL, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channel5  , TC0_CH1   , TC0_CH1     , EXTERNAL_INT_5    }, // D4

  // 5..12  
  { PORTB, 16, PIO_DIGITAL   , PIN_ATTR_PWM_E                  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0    }, // PDM_SCK
  { PORTB, 15, PIO_DIGITAL   , PIN_ATTR_PWM_E                  , No_ADC_Channel, TC5_CH1   , TC5_CH1     , EXTERNAL_INT_15   }, // GPS_EN
  { PORTB, 17, PIO_DIGITAL   , PIN_ATTR_PWM_E                  , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_1    }, // SD_CS
  { PORTB, 14, PIO_DIGITAL   , PIN_ATTR_PWM_E                  , No_ADC_Channel, TC5_CH0   , TC5_CH0     , EXTERNAL_INT_14   }, // LIS_INT
  { PORTB,  4, PIO_ANALOG   , PIN_ATTR_ANALOG                   , ADC_Channel1, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4    }, // NTC_POWER
